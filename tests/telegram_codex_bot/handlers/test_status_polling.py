...
class TestStatusPollerSettingsDetection:
    ...
    async def test_missing_bound_window_is_kept_for_recovery(self, mock_bot: AsyncMock):
        ...
        with (
            ...
            patch(
                "telegram_codex_bot.handlers.status_polling.session_manager"
            ) as mock_sm,
            patch(
                "telegram_codex_bot.handlers.status_polling.enqueue_status_update",
                new_callable=AsyncMock,
            ...
            patch(
                "telegram_codex_bot.handlers.status_polling.clear_topic_state",
                new_callable=AsyncMock,
            ) as mock_clear_topic_state,
            patch(
                "telegram_codex_bot.handlers.status_polling.asyncio.sleep",
                new_callable=AsyncMock,
