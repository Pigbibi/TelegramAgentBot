...
import telegram_codex_bot.tmux_manager as tmux_manager_module
    ...
    async def test_create_window_uses_resume_subcommand(self) -> None:
        ...
        with tempfile.TemporaryDirectory(
            ...
            with (
                ...
                patch(
                    "telegram_codex_bot.tmux_manager.ensure_account_home",
                    return_value=Path("/tmp/telegram-codex-bot-account-home"),
                ),
            ):
        ...
        self.assertEqual(
            ...
            [
                (
                    "export CODEX_HOME=/tmp/telegram-codex-bot-account-home; "
    ...
    async def test_create_window_strips_rollout_prefix_for_resume(self) -> None:
        ...
        with tempfile.TemporaryDirectory(
            ...
            with (
                ...
                patch.object(manager, "get_or_create_session", return_value=session),
                patch(
                    "telegram_codex_bot.tmux_manager.disable_codex_update_prompt"
                ) as disable_mock,
                patch.object(
                    tmux_manager_module.config,
                    "codex_command",
