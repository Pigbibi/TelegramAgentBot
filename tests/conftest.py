"""Root conftest — sets env vars BEFORE any telegram-codex-bot module is imported.
...
discovers any test that transitively imports telegram-codex-bot.
"""
...
os.environ["TELEGRAM_CODEX_BOT_DIR"] = tempfile.mkdtemp(
    prefix="telegram-codex-bot-test-"
)
