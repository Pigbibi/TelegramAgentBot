...
# Never let developer/VPS runtime policy leak into tests. Tests that exercise
# environment overrides set their own values explicitly.
for key in tuple(os.environ):
    if key.startswith(("TELEGRAM_AGENT_BOT_", "TELEGRAM_CODEX_BOT_")):
