...
TELEGRAM_CODEX_BOT_DIR_ENV = "TELEGRAM_CODEX_BOT_DIR"
...
def app_dir() -> Path:
    """Resolve config directory from TELEGRAM_CODEX_BOT_DIR env var or default ~/.telegram-codex-bot."""
    raw = os.environ.get(TELEGRAM_CODEX_BOT_DIR_ENV, "")
    return Path(raw) if raw else Path.home() / ".telegram-codex-bot"
