"""Helpers for managing multiple Codex auth snapshots for telegram-codex-bot."""
...
TELEGRAM_CODEX_BOT_ACCOUNTS_DIR = app_dir() / "accounts"
SNAPSHOT_DIR = TELEGRAM_CODEX_BOT_ACCOUNTS_DIR / "snapshots"
...
def _disable_codex_update_prompt(config_file: Path) -> None:
    """Ensure telegram-codex-bot-managed Codex starts do not block on the update prompt."""
