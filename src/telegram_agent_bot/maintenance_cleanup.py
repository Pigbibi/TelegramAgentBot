...
def build_protected_paths(home: Path) -> tuple[Path, ...]:
    ...
    extra = os.getenv("TELEGRAM_AGENT_BOT_CLEANUP_PROTECTED_PATHS", "")
...
def discover_action_runners(home: Path) -> list[Path]:
    roots_env = os.getenv("TELEGRAM_AGENT_BOT_CLEANUP_RUNNER_ROOTS", "")
    if roots_env.strip():
        return [
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=float,
        default=_env_float(
            "TELEGRAM_AGENT_BOT_CLEANUP_MAX_USED_PERCENT", DEFAULT_MAX_USED_PERCENT
        ),
    )
    parser.add_argument(
        "--min-free-gb",
    ...
    parser.add_argument(
        ...
        type=int,
        default=_env_int(
            "TELEGRAM_AGENT_BOT_CLEANUP_TMP_RETENTION_DAYS", DEFAULT_TMP_RETENTION_DAYS
        ),
    )
    parser.add_argument(
        ...
        type=int,
        default=_env_int(
            "TELEGRAM_AGENT_BOT_CLEANUP_CODEX_SESSION_RETENTION_DAYS",
    ...
    parser.add_argument(
        ...
        type=int,
        default=_env_int(
            "TELEGRAM_AGENT_BOT_CLEANUP_RUNNER_DIAG_RETENTION_DAYS",
