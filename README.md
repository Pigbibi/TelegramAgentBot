...
| `TELEGRAM_CODEX_BOT_AGENT_INPUT_QUEUE_MAX_SIZE` | `20` | Maximum pending Telegram inputs per session while Codex is busy |
| `TELEGRAM_CODEX_BOT_AGENT_INPUT_QUEUE_MAX_WAIT_SECONDS` | `1800` | Drop queued inputs after this many seconds if Codex never becomes ready; set `0` to disable expiry |
